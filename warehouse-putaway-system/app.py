"""
Warehouse Putaway Recommendation System - Web Interface
AI-powered location recommendations based on historical patterns
"""
...
def call_ollama(ollama, prompt, system_prompt=None):
    if not ollama:
        ...
        return None
    try:
        logger.info("Calling Ollama LLM for text generation...")
...
st.set_page_config(
    page_title="Putaway Recommendation System",
    page_icon="📦",
    layout="wide",
)
