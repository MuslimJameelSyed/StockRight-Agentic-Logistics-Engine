"""
Configuration module for Warehouse Putaway System
...
class ConfigLocal:
    ...
    def log_config_status(cls):
        ...
        logger.info(f"  MySQL Database: {cls.MYSQL_DATABASE} @ {cls.MYSQL_HOST}:{cls.MYSQL_PORT}")
...
try:
    ...
    logger.critical("Required variables: OLLAMA_HOST, OLLAMA_MODEL, MYSQL_HOST, MYSQL_PASSWORD, QDRANT_URL, QDRANT_API_KEY")
    raise